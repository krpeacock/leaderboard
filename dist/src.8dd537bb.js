...
},{"./cjs/react-dom.development.js":"node_modules/react-dom/cjs/react-dom.development.js"}],"src/Scoreboard.js":[function(require,module,exports) {
"use strict";
  ...
  _createClass(Scoreboard, [{
    ...
    value: function mapPlayers() {
      var _props = this.props,
          ...
          deletePlayer = _props.deletePlayer,
          addingPlayer = _props.addingPlayer,
          toggleEditingPlayer = _props.toggleEditingPlayer;
            ...
            _react2.default.createElement(
              "button",
              {
                onClick: function onClick() {
                  return toggleEditingPlayer(index);
                },
...
},{"react":"node_modules/react/index.js"}],"node_modules/default-compare/node_modules/kind-of/index.js":[function(require,module,exports) {
...
var App = function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    key: "toggleAddPlayer",
    value: function toggleAddPlayer() {
      this.setState({ addingPlayer: !this.state.addingPlayer });
    }
  }, {
    key: "toggleEditingPlayer",
    value: function toggleEditingPlayer(editPlayerIndex) {
      var playerToEdit = this.state.players[editPlayerIndex];
      var firstName = playerToEdit.firstName,
    ...
    value: function render() {
      ...
      var _state2 = this.state,
          ...
          editingPlayer = _state2.editingPlayer,
      ...
      return _react2.default.createElement(
        ...
        addingPlayer || editingPlayer ? _react2.default.createElement(
          "h3",
          null,
          addingPlayer ? "Add a score" : "Update a score"
        ) : null,
        addingPlayer || editingPlayer ? _react2.default.createElement(
          "form",
          { id: "leaderboard-form", onSubmit: handleSubmit },
          _react2.default.createElement(
            "label",
            { htmlFor: "firstName", onChange: handleChange },
            "First Name",
            _react2.default.createElement("input", { type: "text", id: "firstName", value: this.state.firstName })
          ),
          _react2.default.createElement(
            "label",
            { htmlFor: "lastName", onChange: handleChange },
            "Last Name",
            _react2.default.createElement("input", { type: "text", id: "lastName", value: this.state.lastName })
          ),
          _react2.default.createElement(
            "label",
            { htmlFor: "score", onChange: handleChange },
            "Score",
            _react2.default.createElement("input", { type: "text", id: "score", value: this.state.score })
          ),
          _react2.default.createElement(
            "button",
            { type: "submit" },
        ...
        _react2.default.createElement(
          "button",
          { onClick: toggleAddPlayer, disabled: editingPlayer },
...
},{}]},{},["../../.nvm/versions/node/v8.9.4/lib/node_modules/parcel/src/builtins/hmr-runtime.js","src/index.js"], null)
//# sourceMappingURL=/src.8dd537bb.map